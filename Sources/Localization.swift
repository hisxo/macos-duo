...
enum Localization {
    ...
    static let strings: [String: (en: String, fr: String)] = [
        ...
        "capture.choose": ("Choose the built-in display in the macOS picker.", "Choisissez l’écran intégré dans le sélecteur macOS."),
        ...
        "capture.settings": ("Enable MacOS Duo in Screen Recording, then relaunch if macOS asks.", "Activez MacOS Duo dans Enregistrement de l’écran, puis relancez l’app si macOS le demande."),
        ...
        "capture.failed": ("Capture unavailable. Choose your screen again or open macOS Settings.", "Capture indisponible. Choisissez à nouveau votre écran ou ouvrez les réglages macOS."),
        ...
        "capture.required": ("Choose your screen and confirm sharing before testing the desktop effect.", "Choisissez votre écran et confirmez le partage avant de tester l’effet sur le bureau."),
